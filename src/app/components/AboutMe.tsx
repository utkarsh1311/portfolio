		...
		<div className="flex py-36 h-fit items-center sm:flex-col-reverse sm:py-8">
			...
			<Fade triggerOnce cascade damping={0.8} delay={500}>
				<div className="p-16 basis-1/3 grid grid-cols-1 grid-rows-1 md:p-0 sm:mb-16">
					<Image
						src="/anime.jpg"
						className=" aspect-square rounded-lg col-start-1 row-start-1 object-cover rotate-12 sm:w-2/3 sm:mx-auto"
						width={400}
						height={400}
						alt="anime boy"
					/>
					...
					<Image
						src="/profile.jpg"
						className=" aspect-square rounded-lg object-cover col-start-1 row-start-1 z-10 sm:w-2/3 sm:mx-auto"
						width={400}
						height={400}
